...
Generic Solution: Tree Edit Algorithm \([https://grfia.dlsi.ua.es/ml/algorithms/references/editsurvey\_bille.pdf](https://grfia.dlsi.ua.es/ml/algorithms/references/editsurvey_bille.pdf)\)
